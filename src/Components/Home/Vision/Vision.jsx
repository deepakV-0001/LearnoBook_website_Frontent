    ...
    return (
        <div className="vision-main-container">
            ...
            <div className="vision-text-content">
                <h1>Our Vision</h1>
                <p>LearnoBook originally started because our team thought carrying books around was a hassle. Textbooks are big and heavy, and you have to switch them for each class. Losing a book or a notebook means losing all the data that you’ve organized on them.
                </p>
